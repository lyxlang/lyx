...
val build_program : Lyx.Ast.program -> string
(** Translates a Lyx AST into OCaml source code.

    This function transpiles Lyx language constructs directly to their OCaml
    equivalents. It handles type definitions, value bindings, pattern matching,
    algebraic data types, and all expressions supported by the Lyx language.
    ...
    @param program The desugared AST representing a Lyx program.
